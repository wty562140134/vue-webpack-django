...
def monitor_task():
    ...
    for i in unit_ids:
        ...
        return monitor_report, alarm_review, dangers_rectification
...
set_task(monitor_task, when_time=configs['task']['monitor_task']['when_time'],
         at_day_start_time=configs['task']['monitor_task']['at_day_start_time'])
run_task()
